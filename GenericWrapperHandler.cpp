...
sm_data::SharedMemoryContent* SharedMemoryContentWrapper::getPtr()
{
...
sm_data::testStructThree* testStructThreeWrapper::getPtr()
{
...
void testStructTwoWrapper::updatePublish()
{
	_structThree.updatePublish();
}
void testStructTwoWrapper::updateGet()
{
	_structThree.updateGet();
}
...
unsigned int testStructTwoWrapper::getuintNumber() const
{
...
testStructThreeWrapper& testStructTwoWrapper::getstructThree()
{
	return _structThree;
}
testStructThreeWrapper testStructTwoWrapper::getstructThreeConst() const
{
	return _structThree;
}
...
sm_data::testStructTwo* testStructTwoWrapper::getPtr()
{
...
sm_data::testStructFour* testStructFourWrapper::getPtr()
{
