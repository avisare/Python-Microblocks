...
def main():
    ...
    preparation_command = r""""C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\Tools\vsdevcmd.bat" & cd current_directory & "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.11.25503\bin\HostX86\x64\CL.exe" /c /Idll_path_dll /Idll_headrs_path /Zi /nologo /W3 /WX- /diagnostics:classic /sdl /O2 /Oi /GL /D NDEBUG /D _CONSOLE /D _WINDLL /D _UNICODE /D UNICODE /Gm- /EHsc /MD /GS /Gy /fp:precise /Zc:wchar_t /Zc:forScope /Zc:inline /Yc"stdafx.h" /Fp"x64\Release\SharedMemoryWrapper.pch" /Fo"x64\Release\\" /Fd"x64\Release\vc141.pdb" /Gd /TP /errorReport:prompt stdafx.cpp & """
    ...
    compile_command = r""""C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.11.25503\bin\HostX86\x64\CL.exe" /c /Idll_path_dll /Idll_path_headers /Zi /nologo /W3 /WX- /diagnostics:classic /sdl /O2 /Oi /GL /D NDEBUG /D _CONSOLE /D _WINDLL /D _UNICODE /D UNICODE /Gm- /EHsc /MD /GS /Gy /fp:precise /Zc:wchar_t /Zc:forScope /Zc:inline /Yu"stdafx.h" /Fp"x64\Release\SharedMemoryWrapper.pch" /Fo"x64\Release\\" /Fd"x64\Release\vc141.pdb" /Gd /TP /errorReport:prompt SharedMemoryWrapper.cpp"""
    ...
    link_command = r""""C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.29.30133\bin\HostX86\x64\link.exe" /ERRORREPORT:PROMPT /OUT:"current_directory_path\x64\Release\SharedMemoryWrapper.pyd" /INCREMENTAL:NO /NOLOGO /LIBPATH:dll_path_dll python39.lib Shared_Memory_Topics_x64.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /MANIFEST /MANIFESTUAC:"level='asInvoker' uiAccess='false'" /manifest:embed /DEBUG /PDB:"/OUT:"current_directory_path\x64\Release\SharedMemoryWrapper.pdb" /SUBSYSTEM:CONSOLE /OPT:REF /OPT:ICF /LTCG:incremental /TLBID:1 /DYNAMICBASE /NXCOMPAT /IMPLIB:"/OUT:"current_directory_path\x64\Release\SharedMemoryWrapper.lib" /MACHINE:X64 /DLL x64\Release\SharedMemoryWrapper.obj x64\Release\stdafx.obj & """
    ...
    print(one_line_command)
    print(link_command + copy_command)
