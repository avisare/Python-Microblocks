...
void testStructThreeClassRunner(py::module & SharedMemoryWrapperModule)
{
	...
	py::class_<sm_data::testStructThree>(SharedMemoryWrapperModule, "testStructThree")
		...
		.def("paramsCtor", [](sm_data::testStructThree& obj, bool setbooleanValue, float setfloatValue, py::list setcharArray)
	{
		obj.booleanValue = setbooleanValue;
		obj.floatValue = setfloatValue;
