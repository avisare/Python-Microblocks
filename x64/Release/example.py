...
"""
This is a basic example of how things should work, and the right way you can use the
...
class Example:
    ...
    def _create_topic(self):
        ...
        SharedMemoryWrapper.SMT_CreateTopic("SharedMemoryContent", 40, 3, 10)
    ...
    def _publish_objects(self):
        ...
        for shared_memory_object in self._shared_memory_objects:
            SharedMemoryWrapper.send(shared_memory_object)
    ...
    def _get_latest(self):
        ...
        SharedMemoryWrapper.latestRx(shared_memory_temp_object)
    ...
    def _get_by_counter(self):
        ...
        SharedMemoryWrapper.receive(shared_memory_temp_object, 1, 30)
        print("Now the temporary object contain the values:")
        print(f"cstringData: {shared_memory_temp_object.cstringData}, intData: {shared_memory_temp_object.intData}")
    ...
    def _get_oldest(self):
        ...
        SharedMemoryWrapper.oldestRx(shared_memory_temp_object, data_info)
        print("Now the temporary object contain the values:")
        print(f"cstringData: {shared_memory_temp_object.cstringData}, intData: {shared_memory_temp_object.intData}")
