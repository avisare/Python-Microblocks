...
void testStructTwoClassRunner(py::module & SharedMemoryWrapperModule)
{
	...
	py::class_<sm_data::testStructTwo>(SharedMemoryWrapperModule, "testStructTwo")
		...
		.def("paramsCtor", [](sm_data::testStructTwo& obj, long setlongNumber, unsigned int setuintNumber, bool setboolean, sm_data::testStructThree setstructThree)
	{
		obj.longNumber = setlongNumber;
		obj.uintNumber = setuintNumber;
		obj.boolean = setboolean;
		obj.structThree = setstructThree;
	})
